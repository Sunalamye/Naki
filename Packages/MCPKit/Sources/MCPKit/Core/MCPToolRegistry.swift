...
public final class MCPToolRegistry {
    ...
    public func register<T: MCPTool>(_ toolType: T.Type) {
        let name = T.name
    ...
    /// 批量註冊工具
    /// - Parameter types: 工具類型列表
    public func registerAll(_ types: [any MCPTool.Type]) {
    ...
    public func tool(named name: String, context: MCPContext) -> (any MCPTool)? {
    ...
    /// - Returns: 工具定義陣列
    public func allToolDefinitions() -> [[String: Any]] {
    ...
    /// 生成工具定義 JSON（可保存到文件）
    /// - Returns: JSON 字串
    public func generateToolsJSON() -> String? {
